...
def get_client_init(openapi_model: openapi.OpenApiModel) -> ClientInit:
    ...
    return ClientInit(
        ...
        base_urls=[server.url for server in openapi_model.servers],
        headers=get_global_headers(openapi_model.components.lapis_headers_global),
    )
